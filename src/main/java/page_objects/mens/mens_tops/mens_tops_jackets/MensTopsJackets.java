package page_objects.mens.mens_tops.mens_tops_jackets_page;
...
public class MensTopsJackets extends BasePage {
    ...
    private final El MENS_JACKETS_PAGE_HEADER = new El(By.xpath("//h1[@id='page-title-heading']//span[contains(text(),'Jackets')]"), "Mens Jacket Page Header");
